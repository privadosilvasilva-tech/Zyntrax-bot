...
# ==========================================================
# Instalador automático: Sistema de Embeds Personalizadas
# Projeto: zyntrax-bot
# Uso: cole este arquivo na pasta do bot e rode:
#   bash instalar_embeds.sh
# Ele cria a pasta cogs/ (se não existir) e escreve/atualiza
# cogs/embeds.py automaticamente. Não mexe no .env nem em
# nenhum arquivo com token.
# ==========================================================

set -e

echo "📦 Instalando sistema de embeds personalizadas..."

mkdir -p cogs
mkdir -p config

cat > cogs/embeds.py << 'PYEOF'
import discord
...
echo "✅ cogs/embeds.py criado/atualizado com sucesso."
echo "🔄 Reinicie o bot para carregar o novo comando /embed:"
echo "   pm2 restart zyntrax-bot   (se estiver usando PM2)"
echo "   ou: python3 bot.py"
echo ""
echo "📋 Novo comando disponível: /embed (apenas administradores)"
